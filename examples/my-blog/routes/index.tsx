...
export const handler = {
  async GET(req: Request, ctx: HandlerContext): Promise<Response> {
    const data: HomeData = {
      ...
      description:
        "Build lightning-fast web apps with Fresh/Preact and native Rust. Zero external JS runtime, full Fresh compatibility.",
      version: "0.3.0",
      features: [
  ...
  return (
    <div class="home-page">
      <header class="hero">
        ...
        <p
          class="lead"
          style={{ fontSize: "1.25rem", color: "#666", maxWidth: "600px" }}
        >
          {data.description}
        </p>
      ...
      <section class="demo" style={{ marginTop: "3rem" }}>
        ...
        <p>
          Try out the counter island below! This component hydrates on the
          client.
        </p>
