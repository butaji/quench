    ...
    const posts: Post[] = [
      {
        ...
        excerpt:
          "Build lightning-fast web applications with Fresh's islands architecture, compiled to native Rust binaries.",
        date: "2026-05-26",
      ...
      },
      {
        ...
        excerpt:
          "How selective hydration enables partial page interactivity while maintaining excellent performance.",
        date: "2026-05-25",
      ...
      },
      {
        ...
        excerpt:
          "Exploring the benefits and challenges of compiling TypeScript to Rust.",
        date: "2026-05-24",
      ...
      },
      {
        ...
        excerpt:
          "Implementing Preact Signals and computed values in Rust for efficient reactive updates.",
        date: "2026-05-23",
