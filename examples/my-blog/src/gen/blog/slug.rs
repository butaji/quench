...
let posts: std::collections::HashMap<String, {pub title: String, pub content: String, pub date: String, pub author: String, pub tags: Vec<String>}> = {introducing-runts: {title: "Introducing runts: Fresh/Preact with Native Rust", date: "2026-05-26", author: "runts Team", tags: vec!["Rust", "Fresh", "Preact", "Web"], content: 
