#!/bin/bash
# =============================================================================
# INK PARITY TEST HARNESS v5 (Complete 3-Environment Testing)
# =============================================================================
...
#
# Usage: ./test_parity_complete.sh [--no-compile] [--examples ink-counter ...] [--verbose]
# =============================================================================
...
show_help() {
    cat << 'EOF'
INK PARITY TEST HARNESS v5 (Complete 3-Environment)
====================================================
Tests 100% look&feel parity across 3 environments:
...
USAGE:
  ./test_parity_complete.sh [OPTIONS]
...
EXAMPLES:
  ./test_parity_complete.sh                     # Test all examples
  ./test_parity_complete.sh --no-compile         # Quick test (no compilation)
  ./test_parity_complete.sh --examples ink-counter ink-todo
...
test_example() {
    ...
    # Save results
    echo "{\"name\":\"$name\",\"deno_result\":$deno_result,\"hir_result\":$hir_result,\"compile_result\":$compile_result,\"d_h_sim\":$dh_sim}" >> "$SUMMARY_FILE"
...
run_tests() {
    ...
    echo "declare -A RESULTS" >> "$SUMMARY_FILE"
    ...
    echo ""
    echo -e "${BOLD}╔════════════════════════════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BOLD}║${NC}  ${CYAN}INK PARITY TEST HARNESS v5 (Complete 3-Environment)${NC}                        ${BOLD}║${NC}"
    echo -e "${BOLD}╠════════════════════════════════════════════════════════════════════════════════════╣${NC}"
