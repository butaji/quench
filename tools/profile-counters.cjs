...
const result = bounded.spawnSync("/usr/bin/time", ["-l", command, ...args], {
  encoding: "utf8"
});
...
process.stdout.write(
  JSON.stringify({
    ...
    prefetch_approval: {
      ...
      reason:
        metrics.cycles === null || metrics.cache_misses === null
      ...
      unavailable_required: ["cache_misses", "cycles"].filter(
