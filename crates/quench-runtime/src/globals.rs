...
const SCRIPT_PROPERTY_NAMES: &[&str] = &[
    "Object", "Function", "Array", "Promise", "RegExp", "Date", "Map", "Set", "JSON", "Reflect",
    "Proxy", "ArrayBuffer", "DataView", "Intl", "DisposableStack", "AsyncDisposableStack",
    ...
    "parseInt", "parseFloat", "WeakMap", "WeakSet", "SharedArrayBuffer", "WeakRef", "BigInt",
    "Boolean", "Number", "String", "Symbol", "Temporal", "ShadowRealm", "Float64Array",
    "Float32Array", "Int8Array", "Int16Array", "Int32Array", "Uint8Array", "Uint16Array",
...
fn builtin_core(name: &str) -> Option<crate::ops::Builtin> {
    ...
    match name {
        ...
        "Iterator" => Some(crate::ops::Builtin::Iterator),
