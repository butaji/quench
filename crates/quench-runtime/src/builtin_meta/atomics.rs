...
pub const fn fn_name(builtin: Builtin) -> Option<&'static str> {
    Some(match builtin {
        ...
        Builtin::AtomicsWaitAsync => "Atomics.waitAsync",
...
pub const fn fn_len(builtin: Builtin) -> Option<f64> {
    match builtin {
        ...
        Builtin::AtomicsNotify => Some(3.0),
        Builtin::AtomicsWait => Some(4.0),
        Builtin::AtomicsLoad => Some(2.0),
        Builtin::AtomicsStore => Some(3.0),
        Builtin::AtomicsExchange => Some(3.0),
        Builtin::AtomicsWaitAsync => Some(4.0),
        Builtin::AtomicsPause => Some(0.0),
        _ => None,
    }
}
