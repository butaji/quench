...
pub const fn fn_name(b: Builtin) -> Option<&'static str> {
    match b {
        ...
        Builtin::StringSub => Some("String.prototype.sub"),
        Builtin::StringSup => Some("String.prototype.sup"),
...
const fn string_fn_len_0(b: Builtin) -> Option<f64> {
    match b {
        ...
        Builtin::StringSub => Some(0.0),
        Builtin::StringSup => Some(0.0),
...
const fn string_short_name_0(b: Builtin) -> Option<&'static str> {
    match b {
        ...
        Builtin::StringSub => Some("sub"),
        Builtin::StringSup => Some("sup"),
