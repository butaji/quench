pub(crate) fn builtin_property_writable(builtin: Builtin, key: &str) -> bool {
    if builtin == Builtin::TemporalPlainDatePrototype && key == "Symbol.toStringTag" {
        return false;
    }
    if builtin == Builtin::TemporalDurationPrototype && key == "Symbol.toStringTag" {
        return false;
    }
    ...
    if builtin == Builtin::TemporalPlainTimePrototype && key == "Symbol.toStringTag" {
        return false;
    }
    if builtin == Builtin::TemporalPlainDateTimePrototype && key == "Symbol.toStringTag" {
        return false;
    }
    if builtin == Builtin::TemporalNow && key == "Symbol.toStringTag" {
        return false;
    }
