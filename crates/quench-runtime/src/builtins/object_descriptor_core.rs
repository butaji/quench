...
fn intrinsic_getter_tail(builtin: Builtin, key: &str) -> Option<Builtin> {
    ...
    Some(match (builtin, key) {
        ...
        (TemporalPlainDateTimePrototype, "calendarId") => TemporalPlainDateTimeCalendarIdGetter,
        (TemporalPlainDateTimePrototype, "year") => TemporalPlainDateTimeYearGetter,
        (TemporalPlainDateTimePrototype, "month") => TemporalPlainDateTimeMonthGetter,
        (TemporalPlainDateTimePrototype, "monthCode") => TemporalPlainDateTimeMonthCodeGetter,
        (TemporalPlainDateTimePrototype, "day") => TemporalPlainDateTimeDayGetter,
        (TemporalPlainDateTimePrototype, "hour") => TemporalPlainDateTimeHourGetter,
        (TemporalPlainDateTimePrototype, "minute") => TemporalPlainDateTimeMinuteGetter,
        (TemporalPlainDateTimePrototype, "second") => TemporalPlainDateTimeSecondGetter,
        (TemporalPlainDateTimePrototype, "millisecond") => TemporalPlainDateTimeMillisecondGetter,
        (TemporalPlainDateTimePrototype, "microsecond") => TemporalPlainDateTimeMicrosecondGetter,
        (TemporalPlainDateTimePrototype, "nanosecond") => TemporalPlainDateTimeNanosecondGetter,
        (TemporalPlainDateTimePrototype, "dayOfWeek") => TemporalPlainDateTimeDayOfWeekGetter,
        (TemporalPlainDateTimePrototype, "dayOfYear") => TemporalPlainDateTimeDayOfYearGetter,
        (TemporalPlainDateTimePrototype, "daysInMonth") => TemporalPlainDateTimeDaysInMonthGetter,
        (TemporalPlainDateTimePrototype, "daysInWeek") => TemporalPlainDateTimeDaysInWeekGetter,
        (TemporalPlainDateTimePrototype, "daysInYear") => TemporalPlainDateTimeDaysInYearGetter,
        (TemporalPlainDateTimePrototype, "monthsInYear") => TemporalPlainDateTimeMonthsInYearGetter,
        (TemporalPlainDateTimePrototype, "inLeapYear") => TemporalPlainDateTimeInLeapYearGetter,
        (TemporalPlainDateTimePrototype, "era") => TemporalPlainDateTimeEraGetter,
        (TemporalPlainDateTimePrototype, "eraYear") => TemporalPlainDateTimeEraYearGetter,
        (TemporalPlainDateTimePrototype, "weekOfYear") => TemporalPlainDateTimeWeekOfYearGetter,
        (TemporalPlainDateTimePrototype, "yearOfWeek") => TemporalPlainDateTimeYearOfWeekGetter,
        (TemporalPlainTimePrototype, "hour") => TemporalPlainTimeHourGetter,
        (TemporalPlainTimePrototype, "minute") => TemporalPlainTimeMinuteGetter,
        (TemporalPlainTimePrototype, "second") => TemporalPlainTimeSecondGetter,
        (TemporalPlainTimePrototype, "millisecond") => TemporalPlainTimeMillisecondGetter,
        (TemporalPlainTimePrototype, "microsecond") => TemporalPlainTimeMicrosecondGetter,
        (TemporalPlainTimePrototype, "nanosecond") => TemporalPlainTimeNanosecondGetter,
        (TemporalPlainMonthDayPrototype, "calendarId") => TemporalPlainMonthDayCalendarIdGetter,
        (TemporalPlainMonthDayPrototype, "day") => TemporalPlainMonthDayDayGetter,
        (TemporalPlainMonthDayPrototype, "monthCode") => TemporalPlainMonthDayMonthCodeGetter,
        (TemporalPlainYearMonthPrototype, "calendarId") => TemporalPlainYearMonthCalendarIdGetter,
        (TemporalPlainYearMonthPrototype, "year") => TemporalPlainYearMonthYearGetter,
        (TemporalPlainYearMonthPrototype, "month") => TemporalPlainYearMonthMonthGetter,
        (TemporalPlainYearMonthPrototype, "monthCode") => TemporalPlainYearMonthMonthCodeGetter,
        ...
        (TemporalZonedDateTimePrototype, "monthCode") => TemporalPlainDateMonthCodeGetter,
        (TemporalZonedDateTimePrototype, "day") => TemporalPlainDateDayGetter,
        (TemporalZonedDateTimePrototype, "dayOfWeek") => TemporalPlainDateDayOfWeekGetter,
        (TemporalZonedDateTimePrototype, "dayOfYear") => TemporalPlainDateDayOfYearGetter,
        (TemporalZonedDateTimePrototype, "daysInMonth") => TemporalPlainDateDaysInMonthGetter,
        (TemporalZonedDateTimePrototype, "daysInWeek") => TemporalPlainDateDaysInWeekGetter,
        (TemporalZonedDateTimePrototype, "daysInYear") => TemporalPlainDateDaysInYearGetter,
        (TemporalZonedDateTimePrototype, "monthsInYear") => TemporalPlainDateMonthsInYearGetter,
        (TemporalZonedDateTimePrototype, "inLeapYear") => TemporalPlainDateInLeapYearGetter,
        (TemporalZonedDateTimePrototype, "era") => TemporalPlainDateEraGetter,
        (TemporalZonedDateTimePrototype, "eraYear") => TemporalPlainDateEraYearGetter,
        (TemporalZonedDateTimePrototype, "hour") => TemporalPlainTimeHourGetter,
        (TemporalZonedDateTimePrototype, "minute") => TemporalPlainTimeMinuteGetter,
        (TemporalZonedDateTimePrototype, "second") => TemporalPlainTimeSecondGetter,
        (TemporalZonedDateTimePrototype, "millisecond") => TemporalPlainTimeMillisecondGetter,
        (TemporalZonedDateTimePrototype, "microsecond") => TemporalPlainTimeMicrosecondGetter,
        (TemporalZonedDateTimePrototype, "nanosecond") => TemporalPlainTimeNanosecondGetter,
...
fn builtin_special_descriptor(builtin: Builtin, key: &str) -> Option<Value> {
    ...
    if builtin == Builtin::TemporalPlainMonthDayPrototype && key == "Symbol.toStringTag" {
        return Some(descriptor_object_with_flags(
            Value::String("Temporal.PlainMonthDay".into()),
            false,
            false,
            true,
        ));
