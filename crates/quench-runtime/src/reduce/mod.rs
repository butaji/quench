...
pub use module_metadata::{
    ExportBinding, ImportBinding, ModuleMetadata, ModuleRequest, ReexportBinding,
};
...
pub use reduce_statements::{
    ...
    reduce_global_script_source, reduce_module_source, reduce_source, reduce_source_with_type,
    reduce_statement, reduce_statements_no_tail, reduce_statements_no_tail_value,
    reduce_statements_with_locals, ResidualProgram,
};
