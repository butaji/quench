...
fn unit_suffix(unit: Option<&str>, display: &str, locale: &str) -> String {
    match (unit, display) {
        ...
        (Some("year"), "long") => "years".to_string(),
        (Some("year"), "narrow") => "y".to_string(),
        (Some("year"), _) => "yr".to_string(),
        (Some("month"), "long") => "months".to_string(),
        (Some("month"), "narrow") => "mo".to_string(),
        (Some("month"), _) => "mo".to_string(),
        (Some("week"), "long") => "weeks".to_string(),
        (Some("week"), "narrow") => "wk".to_string(),
        (Some("week"), _) => "wk".to_string(),
        (Some("day"), "long") => "days".to_string(),
        (Some("day"), "narrow") => "d".to_string(),
        (Some("day"), _) => "day".to_string(),
        (Some("hour"), "long") => "hours".to_string(),
        (Some("hour"), "narrow") => "h".to_string(),
        (Some("hour"), _) => "hr".to_string(),
        (Some("minute"), "long") => "minutes".to_string(),
        (Some("minute"), "narrow") => "m".to_string(),
        (Some("minute"), _) => "min".to_string(),
