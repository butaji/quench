...
pub enum Builtin {
    ...
    ArrayAt, ArraySort,
    ArrayToReversed, StringAnchor, StringBig, StringBold, StringFixed, StringFontcolor, StringFontsize, StringItalics, StringIncludes, StringLink, StringSmall, StringStrike,
