...
pub enum Builtin {
    ...
    Iterator, IteratorPrototype, IteratorConcat, IteratorFrom, IteratorZip, IteratorZipKeyed, IteratorToArray, IteratorMap, IteratorFilter, IteratorSome, IteratorEvery, IteratorFlatMap, IteratorDrop, IteratorTake, IteratorReduce, IteratorFind, IteratorForEach,
    ...
    DataViewByteLengthGetter, TypedArrayByteLengthGetter, DataViewByteOffsetGetter,
    ...
    ArrayIsArray, ArrayFrom, ArrayFromAsync, ArrayOf,
    TypedArrayFrom, TypedArrayOf,
    ArrayMap, ArrayFilter,
    ArraySome, ArrayEvery,
    ArrayFind, ArrayFindIndex, ArrayFindLast,
    ArrayFindLastIndex, ArrayIncludes,
    ArrayIndexOf, ArrayLastIndexOf,
    ArraySlice, ArrayConcat,
    ArrayFlat, ArrayFlatMap,
    ArrayAt, ArraySort,
    ArrayToReversed, ArrayToSpliced, ArrayWith, ArrayToString,
    StringAnchor, StringBig, StringBlink, StringBold, StringFixed, StringFontcolor, StringFontsize, StringItalics, StringIncludes, StringLink, StringSmall, StringStrike, StringSub, StringSup,
    ...
    StringSubstring, StringSubstr, StringConcat,
    ...
    AtomicsLoad, AtomicsStore, AtomicsExchange, AtomicsWaitAsync, AtomicsPause,
    MathPow, Function,
    ...
    TemporalInstantFrom, TemporalInstantEpochNanosecondsGetter,
    ...
    TemporalZonedDateTimeToLocaleString, TemporalZonedDateTimeToInstant,
    TemporalZonedDateTimeToPlainDateTime, TemporalZonedDateTimeToPlainDate,
    TemporalZonedDateTimeToPlainTime, TemporalZonedDateTimeEquals,
    ...
    TemporalPlainDateWith,
    TemporalPlainDateAdd, TemporalPlainDateSubtract, TemporalPlainDateEquals,
    TemporalPlainDateUntil, TemporalPlainDateSince, TemporalPlainDateToLocaleString,
    ...
    TemporalPlainDateWeekOfYearGetter,
    TemporalPlainDateYearOfWeekGetter,
    TemporalPlainDateDayGetter,
    TemporalPlainDateYearGetter,
    TemporalPlainDateMonthCodeGetter,
    TemporalPlainDateMonthGetter,
    TemporalPlainDateTime, TemporalPlainDateTimePrototype,
    TemporalPlainDateTimeFrom, TemporalPlainDateTimeCompare,
    TemporalPlainDateTimeCalendarIdGetter, TemporalPlainDateTimeYearGetter,
    TemporalPlainDateTimeMonthGetter, TemporalPlainDateTimeMonthCodeGetter,
    TemporalPlainDateTimeDayGetter, TemporalPlainDateTimeHourGetter,
    TemporalPlainDateTimeMinuteGetter, TemporalPlainDateTimeSecondGetter,
    TemporalPlainDateTimeMillisecondGetter, TemporalPlainDateTimeMicrosecondGetter,
    TemporalPlainDateTimeNanosecondGetter, TemporalPlainDateTimeAdd,
    TemporalPlainDateTimeSubtract, TemporalPlainDateTimeWith,
    TemporalPlainDateTimeRound, TemporalPlainDateTimeEquals,
    TemporalPlainDateTimeToString, TemporalPlainDateTimeToJSON,
    TemporalPlainDateTimeToLocaleString, TemporalPlainDateTimeValueOf,
    TemporalPlainDateTimeUntil, TemporalPlainDateTimeSince, TemporalPlainDateTimeToPlainDate,
    TemporalPlainDateTimeToPlainTime, TemporalPlainDateTimeToZonedDateTime,
    TemporalPlainDateTimeWithCalendar, TemporalPlainDateTimeWithPlainTime,
    TemporalPlainDateTimeDayOfWeekGetter, TemporalPlainDateTimeDayOfYearGetter,
    TemporalPlainDateTimeDaysInMonthGetter, TemporalPlainDateTimeDaysInWeekGetter,
    TemporalPlainDateTimeDaysInYearGetter, TemporalPlainDateTimeMonthsInYearGetter,
    TemporalPlainDateTimeInLeapYearGetter, TemporalPlainDateTimeEraGetter,
    TemporalPlainDateTimeEraYearGetter, TemporalPlainDateTimeWeekOfYearGetter,
    TemporalPlainDateTimeYearOfWeekGetter,
    TemporalPlainTime, TemporalPlainTimePrototype,
    TemporalPlainTimeFrom, TemporalPlainTimeCompare,
    ...
    TemporalPlainTimeAdd, TemporalPlainTimeSubtract, TemporalPlainTimeWith,
    TemporalPlainTimeRound, TemporalPlainTimeEquals, TemporalPlainTimeUntil,
    TemporalPlainTimeSince, TemporalPlainTimeToString, TemporalPlainTimeToJSON,
    TemporalPlainTimeToLocaleString, TemporalPlainTimeValueOf,
    TemporalPlainMonthDay, TemporalPlainMonthDayPrototype,
    TemporalPlainMonthDayFrom, TemporalPlainMonthDayCompare,
    ...
    TemporalPlainMonthDayValueOf, TemporalPlainMonthDayWith,
    TemporalPlainYearMonth, TemporalPlainYearMonthPrototype,
    TemporalPlainYearMonthFrom, TemporalPlainYearMonthCompare,
    ...
    TemporalPlainYearMonthEquals, TemporalPlainYearMonthToString,
    TemporalPlainYearMonthToJSON, TemporalPlainYearMonthToLocaleString,
    TemporalPlainYearMonthToPlainDate, TemporalPlainYearMonthValueOf,
    TemporalPlainYearMonthWith, TemporalPlainYearMonthAdd,
    TemporalPlainYearMonthSubtract, TemporalPlainYearMonthUntil,
    TemporalPlainYearMonthSince, TemporalPlainYearMonthDaysInMonthGetter,
    TemporalPlainYearMonthDaysInYearGetter, TemporalPlainYearMonthInLeapYearGetter,
    TemporalPlainYearMonthMonthsInYearGetter, TemporalPlainYearMonthEraGetter,
    TemporalPlainYearMonthEraYearGetter,
    TemporalNow, TemporalNowInstant, TemporalNowPlainDateISO,
    TemporalNowPlainDateTimeISO, TemporalNowPlainTimeISO,
    TemporalNowTimeZoneId, TemporalNowZonedDateTimeISO,
    ...
    IntlPluralRulesSelect, IntlPluralRulesSelectRange, IntlPluralRulesResolvedOptions,
    ...
    WeakRefDeref, IteratorNext, IteratorReturn, IteratorDispose,
    IteratorPrototypeConstructorGetter, IteratorPrototypeConstructorSetter,
    IteratorPrototypeToStringTagGetter, IteratorPrototypeToStringTagSetter,
