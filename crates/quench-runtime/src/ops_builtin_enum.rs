...
pub enum Builtin {
    ...
    DataViewByteLengthGetter, TypedArrayByteLengthGetter, TypedArrayByteOffsetGetter, DataViewByteOffsetGetter,
    ...
    ArrayReduceRight, ArrayForEach, TypedArrayEntries,
