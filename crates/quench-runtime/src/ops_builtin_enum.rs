...
pub enum Builtin {
    ...
    ArrayAt, ArraySort,
    ArrayToReversed, StringAnchor, StringBig, StringBlink, StringBold, StringFixed, StringFontcolor, StringFontsize, StringItalics, StringIncludes, StringLink, StringSmall, StringStrike, StringSub, StringSup,
