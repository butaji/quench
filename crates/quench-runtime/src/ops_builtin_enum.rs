...
pub enum Builtin {
    ...
    DataViewByteLengthGetter, TypedArrayBufferGetter, TypedArrayByteLengthGetter, TypedArrayByteOffsetGetter, TypedArrayLengthGetter, TypedArrayToStringTagGetter, DataViewByteOffsetGetter,
    ...
    TypedArrayFind, TypedArrayFindIndex, TypedArrayFindLast, TypedArrayFindLastIndex, TypedArraySome, TypedArrayMap, TypedArrayFilter, TypedArraySlice,
    ...
    TypedArrayReverse, TypedArrayCopyWithin,
    ...
    TemporalZonedDateTimeAdd, TemporalZonedDateTimeSubtract,
    ...
    ErrorIsError, ErrorCaptureStackTrace, ErrorPrototypeToString,
