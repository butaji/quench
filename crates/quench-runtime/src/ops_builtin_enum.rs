...
pub enum Builtin {
    ...
    Iterator, IteratorPrototype, IteratorConcat, IteratorFrom, IteratorZip, IteratorToArray, IteratorMap, IteratorFilter, IteratorSome, IteratorEvery, IteratorFlatMap, IteratorDrop, IteratorTake, IteratorReduce, IteratorFind, IteratorForEach,
