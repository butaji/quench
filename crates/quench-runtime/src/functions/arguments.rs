...
include!("arguments_setup.rs");
include!("forwarding_constructor.rs");
...
fn execute_bound_builtin(
    ...
    if builtin == crate::ops::Builtin::IntlNumberFormatFormat {
        eprintln!("DEBUG bound receiver {:?}", bound.receiver);
    }
...
include!("word_call.rs");
include!("leaf_execution.rs");
include!("shape_kernels.rs");
include!("plan_kernel.rs");
include!("slot_alu.rs");
include!("forward_construct_call.rs");
include!("forward_then_call.rs");
include!("arguments_execution.rs");
include!("arguments_helpers.rs");
