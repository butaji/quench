...
fn define_initialized_field(
    ...
    match &field.key {
        crate::value::InstanceFieldKey::Private(id) => {
            ...
            crate::private::slots::define(&receiver, name, value)?;
            Ok(receiver)
        }
...
fn define_private_method(
    ...
    crate::private::slots::define_method(&receiver, name, value)?;
    Ok(receiver)
}
...
fn define_private_accessor(
    ...
    let name = private_field_name(function, field)?;
    crate::private::slots::define_accessor(&receiver, name, get, set)?;
    Ok(receiver)
}
