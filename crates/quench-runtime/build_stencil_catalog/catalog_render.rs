...
fn abi_expr(declaration: &RegionDeclaration) -> &'static str {
    ...
    match declaration.abi {
        ...
        DeclAbi::I32CounterLoop if target_is_aarch64 => {
            "crate::stencil_select::RegionAbi::I32CounterLoop"
        }
        DeclAbi::BooleanReductionLoop if target_is_aarch64 => {
            "crate::stencil_select::RegionAbi::BooleanReductionLoop"
        }
        DeclAbi::BranchRecurrenceLoop if target_is_aarch64 => {
            "crate::stencil_select::RegionAbi::BranchRecurrenceLoop"
        }
        DeclAbi::NestedXorLoop if target_is_aarch64 => {
            "crate::stencil_select::RegionAbi::NestedXorLoop"
        }
        DeclAbi::SwitchReductionLoop if target_is_aarch64 => {
            "crate::stencil_select::RegionAbi::SwitchReductionLoop"
        }
        DeclAbi::MatrixReductionLoop if target_is_aarch64 => {
        ...
        DeclAbi::NumericI32BitwiseLoop if target_is_aarch64 => {
            "crate::stencil_select::RegionAbi::NumericI32BitwiseLoop"
        }
        DeclAbi::NumericI32PairLoop if target_is_aarch64 => {
            "crate::stencil_select::RegionAbi::NumericI32PairLoop"
        }
        DeclAbi::NumericF64MixedLoop if target_is_aarch64 => {
...
fn abi_variant_name(abi: DeclAbi) -> &'static str {
    match abi {
        ...
        DeclAbi::I32CounterLoop => "I32CounterLoop",
        DeclAbi::BooleanReductionLoop => "BooleanReductionLoop",
        DeclAbi::BranchRecurrenceLoop => "BranchRecurrenceLoop",
        DeclAbi::NestedXorLoop => "NestedXorLoop",
        ...
        DeclAbi::NumericF64MixedLoop => "NumericF64MixedLoop",
