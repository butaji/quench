...
rust_assembly_catalog! {
    ...
    TwoStateI32Loop {
        name: "two_state_i32_loop", abi: TwoStateI32Loop,
    ...
    NumericFloatingLoop {
        name: "numeric_floating_loop", abi: NumericF64Loop,
    ...
    NumericIndependentLoop {
        name: "numeric_independent_loop", abi: NumericI32PairLoop,
        ops: ["Mul", "Add", "Binary", "Jump"],
        x86: &[], aarch64: &[], x86_holes: &[], aarch64_holes: &[]
    },
    NumericMixedLoop {
