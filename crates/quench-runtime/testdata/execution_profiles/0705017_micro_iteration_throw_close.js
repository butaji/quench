...
var __profileState=__profileSpec.setup(64,17,"throw_close");var __profileOperation=__profileSpec.variants["throw_close"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"throw_close");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"64\"],[\"number\",\"1\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
