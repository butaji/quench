...
var __profileState=__profileSpec.setup(64,17,"function_construct");var __profileOperation=__profileSpec.variants["function_construct"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"function_construct");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"2080\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
