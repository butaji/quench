...
var __profileState=__profileSpec.setup(64,17,"function_construct");var __profileOperation=__profileSpec.variants["function_construct"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"function_construct");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"2080\"]","exact encoded result");return signature;}
return __profileRun();
