...
var __profileState=__profileSpec.setup(64,17,"substring");var __profileOperation=__profileSpec.variants["substring"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"substring");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"6271\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
