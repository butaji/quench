...
var __profileState=__profileSpec.setup(64,17,"surrogate");var __profileOperation=__profileSpec.variants["surrogate"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"surrogate");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"3546624\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
