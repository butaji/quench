...
var __profileState=__profileSpec.setup(64,17,"surrogate");var __profileOperation=__profileSpec.variants["surrogate"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"surrogate");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"3546624\"]","exact encoded result");return signature;}
return __profileRun();
