...
var __profileState=__profileSpec.setup(64,17,"finally");var __profileOperation=__profileSpec.variants["finally"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"finally");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"2016\"],[\"number\",\"64\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
