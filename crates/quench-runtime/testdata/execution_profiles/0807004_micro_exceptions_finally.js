...
var __profileState=__profileSpec.setup(64,17,"finally");var __profileOperation=__profileSpec.variants["finally"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"finally");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"array\",[[\"number\",\"2016\"],[\"number\",\"64\"]]]","exact encoded result");return signature;}
return __profileRun();
