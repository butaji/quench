...
var __profileState=__profileSpec.setup(64,17,"arguments");var __profileOperation=__profileSpec.variants["arguments"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"arguments");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"-451678767\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
