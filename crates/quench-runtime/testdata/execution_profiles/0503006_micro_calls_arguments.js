...
var __profileState=__profileSpec.setup(64,17,"arguments");var __profileOperation=__profileSpec.variants["arguments"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"arguments");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"-451678767\"]","exact encoded result");return signature;}
return __profileRun();
