...
var __profileState=__profileSpec.setup(64,17,"json_parse");var __profileOperation=__profileSpec.variants["json_parse"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"json_parse");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"64\"],[\"number\",\"80\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
