...
var __profileState=__profileSpec.setup(64,17,"early_exit");var __profileOperation=__profileSpec.variants["early_exit"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"early_exit");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"21\"]","exact encoded result");return signature;}
return __profileRun();
