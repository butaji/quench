...
var __profileState=__profileSpec.setup(64,17,"early_exit");var __profileOperation=__profileSpec.variants["early_exit"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"early_exit");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"21\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
