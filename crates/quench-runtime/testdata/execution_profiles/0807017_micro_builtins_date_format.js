...
var __profileState=__profileSpec.setup(64,17,"date_format");var __profileOperation=__profileSpec.variants["date_format"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"date_format");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"1536\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
