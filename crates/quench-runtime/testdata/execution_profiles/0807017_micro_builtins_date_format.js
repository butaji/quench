...
var __profileState=__profileSpec.setup(64,17,"date_format");var __profileOperation=__profileSpec.variants["date_format"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"date_format");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"1536\"]","exact encoded result");return signature;}
return __profileRun();
