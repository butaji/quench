...
var __profileState=__profileSpec.setup(64,17,"bigint");var __profileOperation=__profileSpec.variants["bigint"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"bigint");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"bigint\",\"351545329\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
