...
var __profileState=__profileSpec.setup(64,17,"bigint");var __profileOperation=__profileSpec.variants["bigint"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"bigint");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"bigint\",\"351545329\"]","exact encoded result");return signature;}
return __profileRun();
