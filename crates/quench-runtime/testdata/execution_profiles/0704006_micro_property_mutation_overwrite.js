...
var __profileState=__profileSpec.setup(64,17,"overwrite");var __profileOperation=__profileSpec.variants["overwrite"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"overwrite");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"array\",[[\"number\",\"2016\"],[\"array\",[[\"string\",\"x\"],[\"string\",\"y\"]]]]]","exact encoded result");return signature;}
return __profileRun();
