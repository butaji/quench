...
var __profileState=__profileSpec.setup(64,17,"overwrite");var __profileOperation=__profileSpec.variants["overwrite"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"overwrite");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"2016\"],[\"array\",[[\"string\",\"x\"],[\"string\",\"y\"]]]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
