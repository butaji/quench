...
var __profileState=__profileSpec.setup(64,17,"closure_allocation");var __profileOperation=__profileSpec.variants["closure_allocation"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"closure_allocation");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"3104\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
