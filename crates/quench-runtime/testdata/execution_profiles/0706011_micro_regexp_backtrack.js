...
var __profileState=__profileSpec.setup(64,17,"backtrack");var __profileOperation=__profileSpec.variants["backtrack"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"backtrack");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"64\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
