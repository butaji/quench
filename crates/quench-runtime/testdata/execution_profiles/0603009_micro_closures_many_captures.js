...
var __profileState=__profileSpec.setup(64,17,"many_captures");var __profileOperation=__profileSpec.variants["many_captures"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"many_captures");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"6752\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
