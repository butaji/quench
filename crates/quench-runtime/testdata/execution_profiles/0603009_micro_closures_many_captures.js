...
var __profileState=__profileSpec.setup(64,17,"many_captures");var __profileOperation=__profileSpec.variants["many_captures"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"many_captures");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"6752\"]","exact encoded result");return signature;}
return __profileRun();
