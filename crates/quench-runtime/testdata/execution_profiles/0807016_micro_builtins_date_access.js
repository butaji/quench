...
var __profileState=__profileSpec.setup(64,17,"date_access");var __profileOperation=__profileSpec.variants["date_access"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"date_access");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"128\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
