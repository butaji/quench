...
var __profileState=__profileSpec.setup(64,17,"date_access");var __profileOperation=__profileSpec.variants["date_access"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"date_access");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"128\"]","exact encoded result");return signature;}
return __profileRun();
