...
var __profileState=__profileSpec.setup(64,17,"date_construct");var __profileOperation=__profileSpec.variants["date_construct"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"date_construct");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"811\"]","exact encoded result");return signature;}
return __profileRun();
