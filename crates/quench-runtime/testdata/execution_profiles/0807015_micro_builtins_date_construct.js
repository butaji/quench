...
var __profileState=__profileSpec.setup(64,17,"date_construct");var __profileOperation=__profileSpec.variants["date_construct"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"date_construct");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"811\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
