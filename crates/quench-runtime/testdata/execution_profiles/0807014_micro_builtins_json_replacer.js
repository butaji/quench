...
var __profileState=__profileSpec.setup(64,17,"json_replacer");var __profileOperation=__profileSpec.variants["json_replacer"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"json_replacer");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"array\",[[\"number\",\"577\"],[\"number\",\"129\"]]]","exact encoded result");return signature;}
return __profileRun();
