...
var __profileState=__profileSpec.setup(64,17,"retained");var __profileOperation=__profileSpec.variants["retained"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"retained");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"2016\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
