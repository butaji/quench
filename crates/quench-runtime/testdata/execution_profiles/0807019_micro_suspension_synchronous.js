...
var __profileState=__profileSpec.setup(64,17,"synchronous");var __profileOperation=__profileSpec.variants["synchronous"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"synchronous");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"81\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
