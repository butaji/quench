...
var __profileState=__profileSpec.setup(64,17,"occasional");var __profileOperation=__profileSpec.variants["occasional"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"occasional");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"2016\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
