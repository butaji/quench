...
var __profileState=__profileSpec.setup(64,17,"inherited_index");var __profileOperation=__profileSpec.variants["inherited_index"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"inherited_index");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"1088\"],[\"number\",\"64\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
