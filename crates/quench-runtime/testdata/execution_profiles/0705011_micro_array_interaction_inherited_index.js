...
var __profileState=__profileSpec.setup(64,17,"inherited_index");var __profileOperation=__profileSpec.variants["inherited_index"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"inherited_index");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"array\",[[\"number\",\"1088\"],[\"number\",\"64\"]]]","exact encoded result");return signature;}
return __profileRun();
