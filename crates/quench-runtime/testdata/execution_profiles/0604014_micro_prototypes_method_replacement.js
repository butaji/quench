...
var __profileState=__profileSpec.setup(64,17,"method_replacement");var __profileOperation=__profileSpec.variants["method_replacement"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"method_replacement");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"96\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
