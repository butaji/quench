...
var __profileState=__profileSpec.setup(64,17,"string_case");var __profileOperation=__profileSpec.variants["string_case"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"string_case");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"577\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
