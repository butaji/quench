...
var __profileState=__profileSpec.setup(64,17,"accessor_transition");var __profileOperation=__profileSpec.variants["accessor_transition"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"accessor_transition");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"2464\"],[\"number\",\"64\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
