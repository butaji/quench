...
var __profileState=__profileSpec.setup(64,17,"bitwise");var __profileOperation=__profileSpec.variants["bitwise"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"bitwise");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"-485132512\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
