...
var __profileState=__profileSpec.setup(64,17,"grow");var __profileOperation=__profileSpec.variants["grow"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"grow");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"80\"]","exact encoded result");return signature;}
return __profileRun();
