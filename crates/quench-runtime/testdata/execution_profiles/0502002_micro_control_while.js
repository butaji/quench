...
var __profileState=__profileSpec.setup(64,17,"while");var __profileOperation=__profileSpec.variants["while"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"while");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"223\"]","exact encoded result");return signature;}
return __profileRun();
