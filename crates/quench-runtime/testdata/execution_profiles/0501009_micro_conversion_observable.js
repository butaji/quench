...
var __profileState=__profileSpec.setup(64,17,"observable");var __profileOperation=__profileSpec.variants["observable"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"observable");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"965\"],[\"number\",\"64\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
