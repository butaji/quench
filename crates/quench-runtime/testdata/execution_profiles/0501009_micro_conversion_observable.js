...
var __profileState=__profileSpec.setup(64,17,"observable");var __profileOperation=__profileSpec.variants["observable"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"observable");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"array\",[[\"number\",\"965\"],[\"number\",\"64\"]]]","exact encoded result");return signature;}
return __profileRun();
