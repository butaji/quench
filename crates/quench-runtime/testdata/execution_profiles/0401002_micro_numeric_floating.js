...
var __profileState=__profileSpec.setup(64,17,"floating");var __profileOperation=__profileSpec.variants["floating"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"floating");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"25.76512079333481\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
