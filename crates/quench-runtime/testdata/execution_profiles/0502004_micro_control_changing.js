...
var __profileState=__profileSpec.setup(64,17,"changing");var __profileOperation=__profileSpec.variants["changing"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"changing");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"0\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
