...
var __profileState=__profileSpec.setup(64,17,"direct_eval");var __profileOperation=__profileSpec.variants["direct_eval"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"direct_eval");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"3168\"]","exact encoded result");return signature;}
return __profileRun();
