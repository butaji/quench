...
var __profileState=__profileSpec.setup(64,17,"direct_eval");var __profileOperation=__profileSpec.variants["direct_eval"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"direct_eval");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"3168\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
