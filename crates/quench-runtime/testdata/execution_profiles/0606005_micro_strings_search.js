...
var __profileState=__profileSpec.setup(64,17,"search");var __profileOperation=__profileSpec.variants["search"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"search");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"array\",[[\"number\",\"1\"],[\"number\",\"-1\"],[\"number\",\"190\"]]]","exact encoded result");return signature;}
return __profileRun();
