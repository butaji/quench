...
var __profileState=__profileSpec.setup(64,17,"search");var __profileOperation=__profileSpec.variants["search"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"search");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"1\"],[\"number\",\"-1\"],[\"number\",\"190\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
