...
var __profileState=__profileSpec.setup(64,17,"json_reviver");var __profileOperation=__profileSpec.variants["json_reviver"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"json_reviver");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"64\"],[\"number\",\"129\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
