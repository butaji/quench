...
var __profileState=__profileSpec.setup(64,17,"json_reviver");var __profileOperation=__profileSpec.variants["json_reviver"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"json_reviver");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"array\",[[\"number\",\"64\"],[\"number\",\"129\"]]]","exact encoded result");return signature;}
return __profileRun();
