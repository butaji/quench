...
var __profileState=__profileSpec.setup(64,17,"string_regexp");var __profileOperation=__profileSpec.variants["string_regexp"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"string_regexp");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"320\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
