...
var __profileState=__profileSpec.setup(64,17,"string_regexp");var __profileOperation=__profileSpec.variants["string_regexp"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"string_regexp");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"320\"]","exact encoded result");return signature;}
return __profileRun();
