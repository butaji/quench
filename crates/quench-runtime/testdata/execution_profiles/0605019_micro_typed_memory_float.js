...
var __profileState=__profileSpec.setup(64,17,"float");var __profileOperation=__profileSpec.variants["float"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"float");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"443.42857142857144\"]","exact encoded result");return signature;}
return __profileRun();
