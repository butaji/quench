...
var __profileState=__profileSpec.setup(64,17,"float");var __profileOperation=__profileSpec.variants["float"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"float");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"443.42857142857144\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
