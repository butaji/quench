...
var __profileState=__profileSpec.setup(64,17,"await");var __profileOperation=__profileSpec.variants["await"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");async function __profileRun(){var value=await __profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"await");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"81\"]","exact encoded result");return signature;}
return __profileRun();
