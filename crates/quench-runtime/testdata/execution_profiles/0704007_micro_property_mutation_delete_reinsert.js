...
var __profileState=__profileSpec.setup(64,17,"delete_reinsert");var __profileOperation=__profileSpec.variants["delete_reinsert"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"delete_reinsert");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"array\",[[\"number\",\"2016\"],[\"array\",[[\"string\",\"y\"],[\"string\",\"x\"]]]]]","exact encoded result");return signature;}
return __profileRun();
