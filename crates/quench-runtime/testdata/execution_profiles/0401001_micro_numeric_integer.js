...
var __profileState=__profileSpec.setup(64,17,"integer");var __profileOperation=__profileSpec.variants["integer"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"integer");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"351545329\"]","exact encoded result");return signature;}
return __profileRun();
