...
var __profileState=__profileSpec.setup(64,17,"ordinary");var __profileOperation=__profileSpec.variants["ordinary"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"ordinary");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"1088\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
