...
var __profileState=__profileSpec.setup(64,17,"presized");var __profileOperation=__profileSpec.variants["presized"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"presized");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"80\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
