...
var __profileState=__profileSpec.setup(64,17,"concat");var __profileOperation=__profileSpec.variants["concat"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"concat");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"194\"],[\"number\",\"99\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
