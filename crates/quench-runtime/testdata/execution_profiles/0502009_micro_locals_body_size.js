...
var __profileState=__profileSpec.setup(64,17,"body_size");var __profileOperation=__profileSpec.variants["body_size"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"body_size");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"number\",\"3168\"]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
