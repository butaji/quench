...
var __profileState=__profileSpec.setup(64,17,"no_match");var __profileOperation=__profileSpec.variants["no_match"];__profileAssert(typeof __profileOperation==="function","selected variant is callable");function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"no_match");var signature=JSON.stringify(__profileEncode(value));__profileAssert(signature==="[\"number\",\"0\"]","exact encoded result");return signature;}
return __profileRun();
