...
var __profileState=__profileSpec.setup(64,17,"independent");var __profileOperation=__profileSpec.variants["independent"];function __profileRun(){var value=__profileOperation(__profileState);if(__profileSpec.check)__profileSpec.check(value,__profileState,"independent");var signature=JSON.stringify(__profileEncode(value));if(signature!=="[\"array\",[[\"number\",\"351545329\"],[\"number\",\"91467762\"]]]")throw new Error("micro exact result mismatch");return signature;}
return __profileRun();
