const __quenchDnsFallbacks = (result) => {
  ...
  result.promises ||= {};
  for (
    const method of ["lookup", "resolve", "resolve4", "resolve6", "reverse"]
  ) {
...
const __quenchCryptoKeyObjectData =
  (globalThis.__quenchCryptoKeyObjectData ||= new WeakMap());
