...
node_api! {
    ...
    (SPEC_INTERNAL_ASYNC_HOOKS_NEW_ASYNC_ID, CAP_INTERNAL_ASYNC_HOOKS_NEW_ASYNC_ID, "internal/async_hooks:newAsyncId", 0x11A0),
...
pub const SPEC_PROCESS_GETGROUPS: NodeSpec = NodeSpec::new("process:getgroups", 0x0A2E);
...
pub const SPEC_FS_WRITE_STREAM_AUTO_CLOSE_SET: NodeSpec =
    NodeSpec::new("fs:WriteStream:autoClose:set", 0x7FE4);
...
pub const SPEC_FS_HANDLE_READV: NodeSpec = NodeSpec::new("fs:FileHandle:readv", 0x7FE5);
pub const SPEC_FS_HANDLE_WRITEV: NodeSpec = NodeSpec::new("fs:FileHandle:writev", 0x7FE6);
...
// Keep FileHandle capabilities in the canonical high-id allocation instead of
...
pub const CAP_FS_HANDLE_READV: CapId = SPEC_FS_HANDLE_READV.cap;
pub const CAP_FS_HANDLE_WRITEV: CapId = SPEC_FS_HANDLE_WRITEV.cap;
...
pub const CAP_FS_UTF8STREAM_WRITE: CapId = SPEC_FS_UTF8STREAM_WRITE.cap;
pub const CAP_FS_UTF8STREAM_WRITE_SYNC: CapId = SPEC_FS_UTF8STREAM_WRITE_SYNC.cap;
pub const CAP_FS_UTF8STREAM_FLUSH: CapId = SPEC_FS_UTF8STREAM_FLUSH.cap;
pub const CAP_FS_UTF8STREAM_FLUSH_SYNC: CapId = SPEC_FS_UTF8STREAM_FLUSH_SYNC.cap;
pub const CAP_FS_UTF8STREAM_END: CapId = SPEC_FS_UTF8STREAM_END.cap;
pub const CAP_FS_UTF8STREAM_DESTROY: CapId = SPEC_FS_UTF8STREAM_DESTROY.cap;
pub const CAP_FS_UTF8STREAM_REOPEN: CapId = SPEC_FS_UTF8STREAM_REOPEN.cap;
...
pub const CAP_PROCESS_GETGROUPS: CapId = SPEC_PROCESS_GETGROUPS.cap;
