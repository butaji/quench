...
impl CapabilityName {
    ...
    const Gc: u16 = 2117;
    const V8Serializer: u16 = 2420;
    const V8Deserializer: u16 = 2421;
    const V8SerializerWrite: u16 = 2422;
    const V8SerializerRelease: u16 = 2423;
    const V8DeserializerRead: u16 = 2424;
    const V8Serialize: u16 = 2425;
    const V8Deserialize: u16 = 2426;
    const V8CachedTag: u16 = 2427;
    const V8SetFlags: u16 = 2428;
    const V8HeapStats: u16 = 2429;
    const V8HeapSpaces: u16 = 2430;
    const V8HeapCode: u16 = 2431;
    const V8HeapSnapshot: u16 = 2432;
    const V8SnapshotOn: u16 = 2433;
    const V8SnapshotRead: u16 = 2434;
    const V8Version: u16 = 2435;
    const V8PromiseHook: u16 = 2436;
    const V8HookEnable: u16 = 2437;
    const V8HookDisable: u16 = 2438;
    ...
    const VmModuleInspect: u16 = 0x7FF0;
    ...
    const CryptoKeyObjectConstructor: u16 = 2280;
    const CryptoKeyObjectFrom: u16 = 2281;
    const CryptoKeyObjectToString: u16 = 2282;
    ...
    const InternalFsOpenFileHandle: u16 = 0x7FE1;
    ...
    const ChildGetValidStdio: u16 = 0x1e18;
