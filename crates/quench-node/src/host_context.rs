...
macro_rules! run_host_context {
    ...
    $context.with(|ctx| -> rquickjs::Result<()> {
        ...
        ctx.eval::<(), _>(b"if (globalThis.process) { const write = (chunk) => { globalThis.__quench_console_write(String(chunk)); return true; }; const on = function () { return this; }; const once = function () { return this; }; const removeListener = function () { return this; }; const listenerCount = function () { return 0; }; const eventNames = function () { return []; }; const setEncoding = function () { return this; }; const end = function () { return this; }; const cork = function () { return this; }; const uncork = function () { return this; }; globalThis.process.stdout ||= {}; globalThis.process.stdout.fd ??= 1; globalThis.process.stdout.write ||= write; globalThis.process.stdout.on ||= on; globalThis.process.stdout.addListener ||= on; globalThis.process.stdout.once ||= once; globalThis.process.stdout.removeListener ||= removeListener; globalThis.process.stdout.listenerCount ||= listenerCount; globalThis.process.stdout.eventNames ||= eventNames; globalThis.process.stdout.setEncoding ||= setEncoding; globalThis.process.stdout.end ||= end; globalThis.process.stdout.cork ||= cork; globalThis.process.stdout.uncork ||= uncork; globalThis.process.stderr ||= {}; globalThis.process.stderr.fd ??= 2; globalThis.process.stderr.write ||= write; globalThis.process.stderr.on ||= on; globalThis.process.stderr.addListener ||= on; globalThis.process.stderr.once ||= once; globalThis.process.stderr.removeListener ||= removeListener; globalThis.process.stderr.listenerCount ||= listenerCount; globalThis.process.stderr.eventNames ||= eventNames; globalThis.process.stderr.setEncoding ||= setEncoding; globalThis.process.stderr.end ||= end; globalThis.process.stderr.cork ||= cork; globalThis.process.stderr.uncork ||= uncork; globalThis.process.stdin ||= new globalThis.__nodeEventEmitter(); globalThis.process.stdin.pause ||= () => globalThis.process.stdin; globalThis.process.stdin.resume ||= () => globalThis.process.stdin; globalThis.process.stdin.setEncoding ||= () => globalThis.process.stdin; }")?;
