...
macro_rules! run_host_context {
    ...
    $context.with(|ctx| -> rquickjs::Result<()> {
        ...
        ctx.eval::<(), _>(b"if (globalThis.process) { const write = (chunk) => { globalThis.__quench_console_write(String(chunk)); return true; }; globalThis.process.stdout ||= {}; globalThis.process.stdout.write ||= write; globalThis.process.stderr ||= {}; globalThis.process.stderr.write ||= write; globalThis.process.stdin ||= new globalThis.__nodeEventEmitter(); }")?;
