...
macro_rules! run_host_context {
    ...
    $context.with(|ctx| -> rquickjs::Result<()> {
        ...
        ctx.eval::<(), _>(b"if (globalThis.process) { const write = (chunk) => { globalThis.__quench_console_write(String(chunk)); return true; }; const on = function () { return this; }; const removeListener = function () { return this; }; const setEncoding = function () { return this; }; const end = function () { return this; }; globalThis.process.stdout ||= {}; globalThis.process.stdout.write ||= write; globalThis.process.stdout.on ||= on; globalThis.process.stdout.removeListener ||= removeListener; globalThis.process.stdout.setEncoding ||= setEncoding; globalThis.process.stdout.end ||= end; globalThis.process.stderr ||= {}; globalThis.process.stderr.write ||= write; globalThis.process.stderr.on ||= on; globalThis.process.stderr.removeListener ||= removeListener; globalThis.process.stderr.setEncoding ||= setEncoding; globalThis.process.stderr.end ||= end; globalThis.process.stdin ||= new globalThis.__nodeEventEmitter(); globalThis.process.stdin.pause ||= () => globalThis.process.stdin; globalThis.process.stdin.resume ||= () => globalThis.process.stdin; globalThis.process.stdin.setEncoding ||= () => globalThis.process.stdin; }")?;
