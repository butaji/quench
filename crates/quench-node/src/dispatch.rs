...
const CAP_ASYNC_RESOURCE: u16 = 0x1400;
const CAP_ASYNC_EXECUTION_ID: u16 = 0x1401;
const CAP_ASYNC_TRIGGER_ID: u16 = 0x1402;
const CAP_ASYNC_EXECUTION_RESOURCE: u16 = 0x1403;
const CAP_ASYNC_CREATE_HOOK: u16 = 0x1404;
const CAP_ASYNC_RESOURCE_RUN: u16 = 0x1405;
const CAP_ASYNC_RESOURCE_BEFORE: u16 = 0x1406;
const CAP_ASYNC_RESOURCE_AFTER: u16 = 0x1407;
const CAP_ASYNC_RESOURCE_DESTROY: u16 = 0x1408;
const CAP_ASYNC_RESOURCE_ID: u16 = 0x1409;
const CAP_ASYNC_RESOURCE_TRIGGER: u16 = 0x140A;
const CAP_ASYNC_HOOK_ENABLE: u16 = 0x140B;
const CAP_ASYNC_HOOK_DISABLE: u16 = 0x140C;
...
fn network_dispatch(cap: u16) -> Option<CallHandler> {
    ...
    Some(match cap {
        ...
        CAP_ASYNC_HOOK_ENABLE | CAP_ASYNC_HOOK_DISABLE => crate::modules::async_hooks::hook_toggle,
