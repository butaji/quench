...
const CAP_EVENTS_NEW: u16 = crate::registry::SPEC_EVENTS_NEW.cap;
const CAP_EVENTS_FROM: u16 = crate::registry::SPEC_EVENTS_FROM.cap;
const CAP_EVENTS_ON: u16 = crate::registry::SPEC_EVENTS_ON.cap;
const CAP_EVENTS_EMIT: u16 = crate::registry::SPEC_EVENTS_EMIT.cap;
const CAP_EVENTS_CAPTURE_GET: u16 = crate::registry::SPEC_EVENTS_CAPTURE_GET.cap;
const CAP_EVENTS_CAPTURE_SET: u16 = crate::registry::SPEC_EVENTS_CAPTURE_SET.cap;
const CAP_EVENTS_DEFAULT_MAX_GET: u16 = crate::registry::SPEC_EVENTS_DEFAULT_MAX_GET.cap;
const CAP_EVENTS_DEFAULT_MAX_SET: u16 = crate::registry::SPEC_EVENTS_DEFAULT_MAX_SET.cap;
const CAP_EVENTS_RAW_LISTENERS: u16 = crate::registry::SPEC_EVENTS_RAW_LISTENERS.cap;
const CAP_EVENTS_ONCE: u16 = crate::registry::SPEC_EVENTS_ONCE.cap;
const CAP_EVENTS_REMOVE_LISTENER: u16 = crate::registry::SPEC_EVENTS_REMOVE_LISTENER.cap;
const CAP_EVENTS_REMOVE_ALL: u16 = crate::registry::SPEC_EVENTS_REMOVE_ALL.cap;
const CAP_EVENTS_LISTENERS: u16 = crate::registry::SPEC_EVENTS_LISTENERS.cap;
const CAP_EVENTS_EVENT_NAMES: u16 = crate::registry::SPEC_EVENTS_EVENT_NAMES.cap;
const CAP_EVENTS_LISTENER_COUNT: u16 = crate::registry::SPEC_EVENTS_LISTENER_COUNT.cap;
const CAP_EVENTS_PREPEND: u16 = crate::registry::SPEC_EVENTS_PREPEND.cap;
const CAP_EVENTS_PREPEND_ONCE: u16 = crate::registry::SPEC_EVENTS_PREPEND_ONCE.cap;
const CAP_EVENTS_SET_MAX: u16 = crate::registry::SPEC_EVENTS_SET_MAX.cap;
const CAP_EVENTS_GET_MAX: u16 = crate::registry::SPEC_EVENTS_GET_MAX.cap;
const CAP_EVENTS_SET_MAX_STATIC: u16 = crate::registry::SPEC_EVENTS_SET_MAX_STATIC.cap;
const CAP_EVENTS_GET_LISTENERS: u16 = crate::registry::SPEC_EVENTS_GET_LISTENERS.cap;
const CAP_EVENTS_LISTENER_COUNT_STATIC: u16 =
    crate::registry::SPEC_EVENTS_LISTENER_COUNT_STATIC.cap;
const CAP_EVENTS_GET_MAX_STATIC: u16 = crate::registry::SPEC_EVENTS_GET_MAX_STATIC.cap;
const CAP_EVENTS_ABORT_LISTENER: u16 = crate::registry::SPEC_EVENTS_ABORT_LISTENER.cap;
const CAP_EVENTS_ABORT_DISPOSE: u16 = crate::registry::SPEC_EVENTS_ABORT_DISPOSE.cap;
const CAP_EVENTS_ADD_ABORT: u16 = crate::registry::SPEC_EVENTS_ADD_ABORT.cap;
const CAP_TARGET_ADD: u16 = crate::registry::SPEC_TARGET_ADD.cap;
const CAP_TARGET_REMOVE: u16 = crate::registry::SPEC_TARGET_REMOVE.cap;
const CAP_TARGET_DISPATCH: u16 = crate::registry::SPEC_TARGET_DISPATCH.cap;
const CAP_EVENT_TARGET_NEW: u16 = crate::registry::SPEC_EVENT_TARGET_NEW.cap;
const CAP_RUN_UNCAUGHT: u16 = crate::registry::SPEC_RUN_UNCAUGHT.cap;
...
const CAP_ABORT_SIGNAL_TIMEOUT_FIRE: u16 = 0x1F42;
...
const CAP_EVENT: u16 = crate::registry::SPEC_EVENT.cap;
const CAP_EVENT_PREVENT_DEFAULT: u16 = crate::registry::SPEC_EVENT_PREVENT_DEFAULT.cap;
const CAP_EVENT_STOP_PROPAGATION: u16 = crate::registry::SPEC_EVENT_STOP_PROPAGATION.cap;
const CAP_EVENT_STOP_IMMEDIATE: u16 = crate::registry::SPEC_EVENT_STOP_IMMEDIATE.cap;
const CAP_EVENT_COMPOSED_PATH: u16 = crate::registry::SPEC_EVENT_COMPOSED_PATH.cap;
const CAP_EVENT_GET_CANCEL_BUBBLE: u16 = crate::registry::SPEC_EVENT_GET_CANCEL_BUBBLE.cap;
const CAP_EVENT_SET_CANCEL_BUBBLE: u16 = crate::registry::SPEC_EVENT_SET_CANCEL_BUBBLE.cap;
const CAP_DEFINE_EVENT_HANDLER: u16 = crate::registry::SPEC_DEFINE_EVENT_HANDLER.cap;
const CAP_EVENT_HANDLER_GET: u16 = crate::registry::SPEC_EVENT_HANDLER_GET.cap;
const CAP_EVENT_HANDLER_SET: u16 = crate::registry::SPEC_EVENT_HANDLER_SET.cap;
const CAP_CUSTOM_EVENT: u16 = crate::registry::SPEC_CUSTOM_EVENT.cap;
const CAP_EVENT_SOURCE: u16 = crate::registry::SPEC_EVENT_SOURCE.cap;
