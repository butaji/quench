...
const CAP_CP_TIMEOUT: u16 = crate::registry::SPEC_CP_TIMEOUT.cap;
...
fn network_dispatch(cap: u16) -> Option<CallHandler> {
    ...
    Some(match cap {
        ...
        CAP_INTERNAL_DGRAM_CREATE_SOCKET_HANDLE => handlers::internal_dgram_create_socket_handle,
