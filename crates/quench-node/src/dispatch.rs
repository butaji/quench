...
const CAP_ASSERT_OK: u16 = 0x1420;
const CAP_ASSERT_STRICT_EQUAL: u16 = 0x1421;
const CAP_ASSERT_NOT_STRICT_EQUAL: u16 = 0x1422;
const CAP_ASSERT_EQUAL: u16 = 0x1423;
const CAP_ASSERT_NOT_EQUAL: u16 = 0x1424;
const CAP_ASSERT_DEEP_STRICT_EQUAL: u16 = 0x1425;
const CAP_ASSERT_NOT_DEEP_STRICT_EQUAL: u16 = 0x1426;
const CAP_ASSERT_THROWS: u16 = 0x1427;
const CAP_ASSERT_DOES_NOT_THROW: u16 = 0x1428;
const CAP_ASSERT_FAIL: u16 = 0x1429;
const CAP_ASSERT_IF_ERROR: u16 = 0x142A;
...
const CAP_ASSERT_DEEP_EQUAL: u16 = 0x142F;
const CAP_ASSERT_NOT_DEEP_EQUAL: u16 = 0x1430;
