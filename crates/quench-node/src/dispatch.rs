...
const CAP_CRYPTO_CREATE_HASH: u16 = 0x2103;
const CAP_CRYPTO_CREATE_HMAC: u16 = 0x2104;
const CAP_CRYPTO_TIMING_SAFE_EQUAL: u16 = 0x2105;
const CAP_CRYPTO_RANDOM_UUID: u16 = 0x2106;
...
const CAP_READLINE_QUESTION: u16 = 0x1303;
const CAP_READLINE_WRITE: u16 = 0x1304;
const CAP_READLINE_CLOSE: u16 = 0x1305;
const CAP_READLINE_CALLBACK: u16 = 0x1306;
const CAP_TTY_READSTREAM: u16 = 0x2001;
const CAP_TTY_WRITESTREAM: u16 = 0x2002;
...
const CAP_ASSERT_REJECTS: u16 = 0x140D;
...
const CAP_PROCESS_ACTIVE_RESOURCES: u16 = 0x0A0E;
const CAP_PROCESS_REPORT: u16 = 0x0A0F;
