...
pub fn fs_dispatch(cap: u16) -> Option<CallHandler> {
    Some(match cap {
        ...
        CAP_FS_WRITE_STREAM_RETRY_CALLBACK => crate::modules::fs::write_stream_retry_callback,
        CAP_FS_WRITE_STREAM_FINAL => crate::modules::fs::write_stream_final,
        ...
        CAP_FS_HANDLE_READV => crate::modules::fs::file_handle_readv,
        CAP_FS_HANDLE_CLOSE => crate::modules::fs::file_handle_close,
        CAP_FS_HANDLE_WRITE => crate::modules::fs::file_handle_write,
        CAP_FS_HANDLE_WRITEV => crate::modules::fs::file_handle_writev,
        ...
        CAP_FS_HANDLE_TRUNCATE => crate::modules::fs::file_handle_truncate,
        CAP_FS_HANDLE_APPENDFILE => crate::modules::fs::file_handle_append_file,
        CAP_FS_HANDLE_WRITEFILE => crate::modules::fs::file_handle_write_file,
        CAP_FS_HANDLE_SYNC => crate::modules::fs::file_handle_sync,
        CAP_FS_HANDLE_DATASYNC => crate::modules::fs::file_handle_datasync,
