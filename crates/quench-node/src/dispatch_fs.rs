...
const CAP_FS_OPEN: u16 = 0x115A;
const CAP_FS_OPENDIR: u16 = 0x1155;
const CAP_FS_OPENDIRSYNC: u16 = 0x1156;
const CAP_FS_OPENSYNC: u16 = 0x1160;
const CAP_FS_CLOSESYNC: u16 = 0x1161;
const CAP_FS_READSYNC: u16 = 0x1162;
const CAP_FS_WRITESYNC: u16 = 0x1163;
const CAP_FS_READ: u16 = 0x1164;
const CAP_FS_WRITE: u16 = 0x1165;
const CAP_FS_FSTAT_SYNC: u16 = 0x1166;
const CAP_FS_FTRUNCATE_SYNC: u16 = 0x1167;
const CAP_FS_FSYNC_SYNC: u16 = 0x1168;
const CAP_FS_FDATASYNC_SYNC: u16 = 0x1169;
const CAP_FSP_OPEN: u16 = 0x116A;
