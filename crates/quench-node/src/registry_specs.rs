//! Stable Node capability specifications.
...
pub const SPEC_CONSOLE_COUNT: NodeSpec = NodeSpec::new("console:count", 0x0207);
...
buffer_specs! {
    ...
    (SPEC_BUFFER_SUBARRAY, "buffer.prototype:subarray", 0x0853),
...
pub const SPEC_PROCESS_BINDING: NodeSpec = NodeSpec::new("process:binding", 0x0A15);
...
pub const SPEC_PROCESS_ACTIVE_RESOURCES: NodeSpec =
    NodeSpec::new("process:activeResourcesInfo", 0x0A16);
...
pub const SPEC_PROCESS_KILL: NodeSpec = NodeSpec::new("process:kill", 0x0A12);
pub const SPEC_PROCESS_EXIT_CODE_GET: NodeSpec = NodeSpec::new("process:exitCode:get", 0x0A13);
pub const SPEC_PROCESS_EXIT_CODE_SET: NodeSpec = NodeSpec::new("process:exitCode:set", 0x0A14);
pub const SPEC_PROCESS_EMIT: NodeSpec = NodeSpec::new("process:emit", 0x0A17);
...
pub const SPEC_CRYPTO_SUBTLE_DERIVE_BITS: NodeSpec =
    NodeSpec::new("crypto.subtle.deriveBits", 0x2118);
pub const SPEC_CRYPTO_SUBTLE_DERIVE_KEY: NodeSpec =
    NodeSpec::new("crypto.subtle.deriveKey", 0x2119);
...
pub const SPEC_NET_SOCKET_SET_TIMEOUT: NodeSpec = NodeSpec::new("net:socket:setTimeout", 0x1013);
...
pub const SPEC_FSP_STATFS: NodeSpec = NodeSpec::new("fs:promises:statfs", 0x1152);
...
pub const SPEC_FSP_LINK: NodeSpec = NodeSpec::new("fs:promises:link", 0x117D);
pub const SPEC_FSP_SYMLINK: NodeSpec = NodeSpec::new("fs:promises:symlink", 0x117E);
pub const SPEC_FSP_LUTIMES: NodeSpec = NodeSpec::new("fs:promises:lutimes", 0x117F);
pub const SPEC_FSP_LCHOWN: NodeSpec = NodeSpec::new("fs:promises:lchown", 0x1180);
pub const SPEC_FSP_LCHMOD: NodeSpec = NodeSpec::new("fs:promises:lchmod", 0x1181);
pub const SPEC_FSP_FILEHANDLE_STAT: NodeSpec = NodeSpec::new("fs:promises:FileHandle:stat", 0x1171);
pub const SPEC_FSP_FILEHANDLE_CLOSE: NodeSpec =
    NodeSpec::new("fs:promises:FileHandle:close", 0x1172);
pub const SPEC_FSP_FILEHANDLE_TRUNCATE: NodeSpec =
    NodeSpec::new("fs:promises:FileHandle:truncate", 0x1173);
pub const SPEC_FSP_FILEHANDLE_DATASYNC: NodeSpec =
    NodeSpec::new("fs:promises:FileHandle:datasync", 0x1174);
pub const SPEC_FSP_FILEHANDLE_SYNC: NodeSpec = NodeSpec::new("fs:promises:FileHandle:sync", 0x1175);
pub const SPEC_FSP_FILEHANDLE_WRITE: NodeSpec =
    NodeSpec::new("fs:promises:FileHandle:write", 0x1176);
pub const SPEC_FSP_FILEHANDLE_READ: NodeSpec = NodeSpec::new("fs:promises:FileHandle:read", 0x1177);
pub const SPEC_FSP_FILEHANDLE_CHMOD: NodeSpec =
    NodeSpec::new("fs:promises:FileHandle:chmod", 0x1178);
pub const SPEC_FSP_FILEHANDLE_CHOWN: NodeSpec =
    NodeSpec::new("fs:promises:FileHandle:chown", 0x1179);
pub const SPEC_FSP_FILEHANDLE_UTIMES: NodeSpec =
    NodeSpec::new("fs:promises:FileHandle:utimes", 0x117A);
pub const SPEC_FSP_CHOWN: NodeSpec = NodeSpec::new("fs:promises:chown", 0x117B);
pub const SPEC_FSP_UTIMES: NodeSpec = NodeSpec::new("fs:promises:utimes", 0x117C);
...
pub const SPEC_URL_CAN_PARSE: NodeSpec = NodeSpec::new("url:URL.canParse", 0x0519);
pub const SPEC_URL_PARSE_STATIC: NodeSpec = NodeSpec::new("url:URL.parse", 0x051A);
