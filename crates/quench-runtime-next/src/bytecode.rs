...
opcodes!(
    ...
    Wide => Effect::PURE,
    LoadConst => Effect::PURE; meaning ConstantIndex, @ Register, @ fields(Undeclared, Undeclared, Undeclared),
    LoadLocal => Effect::PURE; meaning LocalSlot, @ Register, @ fields(Undeclared, Undeclared, Undeclared),
    StoreLocal => Effect::PURE; meaning LocalSlot,
    LoadEnvLocal => Effect::READS_HEAP; meaning LocalSlot, @ Register, @ fields(Undeclared, Undeclared, Undeclared),
    ...
    MakeObject => CALL_EFFECT; meaning Unused, @ Register, @ fields(Undeclared, Unused, Unused),
    ...
    SpreadToArray => CALL_EFFECT; meaning Unused, @ Register, @ fields(Undeclared, Register, Unused),
    ...
    ToPropertyKey => READ_THROW, @ Register, @ fields(Undeclared, Register, Undeclared),
    ToNumeric => READ_THROW, @ Register, @ fields(Undeclared, Register, Undeclared),
    CopyDataProperties => CALL_EFFECT, @ NoResult, @ fields(Register, Register, Register),
    MarkPrivateName => Effect::WRITES_HEAP; meaning AtomIndex, @ NoResult, @ fields(Undeclared, Register, Register),
    ...
    CheckPrivate => READ_THROW; meaning AtomIndex, @ NoResult, @ fields(Register, Undeclared, Undeclared),
    PrivateIn => READ_THROW; meaning AtomIndex, @ Register, @ fields(Undeclared, Register, Undeclared),
