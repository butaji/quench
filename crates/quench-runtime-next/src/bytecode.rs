...
opcodes!(
    ...
    ToPropertyKey => READ_THROW, @ Register, @ fields(Undeclared, Register, Unused),
    ToNumeric => READ_THROW, @ Register, @ fields(Undeclared, Register, Unused),
    ...
    IncDec => READ_THROW; meaning BooleanFlag, @ Register, @ fields(Undeclared, Register, Unused),
    Unary => READ_THROW; meaning UnaryOperator, @ Register, @ fields(Undeclared, Register, Unused),
    ...
    Move => Effect::PURE, @ Register, @ fields(Undeclared, Register, Unused),
    ...
    Return => Effect::CONTROL, @ NoResult, @ fields(Register, Unused, Unused),
    Throw => Effect::THROWS.union(Effect::CONTROL), @ NoResult, @ fields(Register, Unused, Unused),
