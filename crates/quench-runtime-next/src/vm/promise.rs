...
impl StaticModuleLinks {
    fn add_local(&mut self, name: String, value: StaticModuleValue) -> Result<(), ()> {
        self.insert_explicit(name, value)
    }

    fn add_locals(&mut self, locals: Vec<(String, StaticModuleValue)>) -> Result<(), ()> {
    ...
    fn insert_explicit(&mut self, name: String, value: StaticModuleValue) -> Result<(), ()> {
...
impl<H: Host> Vm<H> {
    ...
    fn evaluate_javascript_module_body(
        ...
        if let Some(exports) = crate::Engine::module_export_names(&module.source, &module.name) {
            let exports = self.evaluate_module_locals(p, module, exports)?;
    ...
    fn resolve_static_module_plan(
        ...
        if !plan.locals.is_empty() {
            let locals = self.evaluate_module_locals(p, module, plan.locals)?;
