...
fn test_extract_var_declarations_const_number() {
    use crate::codegen::extract_var_declarations;
...
fn test_expr_value_to_rust_ident() {
    use crate::codegen::expr_value_to_rust;
