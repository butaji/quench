...
- the focused bitwise-not partition is 16/16 and the BigInt shift partitions
  ...
  table
- call expressions reach 86/92 in the focused partition; `with` receiver
  identity, strict-eval early errors, and iterator-driven spread abrupt
  completion now run through shared semantics, while six tail-call fixtures
  remain open
...
- the stencil Object stage now reaches 3,411/3,411 and is fully green after
  ...
  computed accessor kinds through stencil lowering, modeling primitive and
  boxed `Object.prototype.toString` tags, `Object.prototype` legacy accessor
  methods and primitive boxing, `__proto__` accessors, RegExp expandos
...
- the stencil AggregateError stage reaches 23/25 after deriving constructor
  ...
  semantics
- the stencil Annex B language stage reaches 836/845; shared binding
...
- the stencil AsyncGeneratorPrototype and AsyncIteratorPrototype stages are
  ...
  the same core
- the stencil Promise stage reaches 729/729; capability construction,
