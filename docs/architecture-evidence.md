...
| 036 | Paired ARM64 three-run sweeps were 100/100: baseline-only Score 250.885 (wall 0.8197, RSS 0.3035, instructions 1.1351, cycles 0.7821) versus optimized-view Score 252.355 (0.7850, 0.3032, 1.0930, 0.7586). The optimized view improves wall time 4.24%, instructions 3.71%, and cycles 3.01%; the composite Score delta is +0.59% because RSS is unchanged. Every native leaf remains target-admitted with canonical fallback. |
| 037 | Correctness gates passed: 580/580 no-default tests, 590/590 execution-trace tests, and `cargo check -p quench-node`. Three independent neutral sweeps were 100/100: interpreter-only Score 249.984 (wall 0.8145, RSS 0.3063, instructions 1.1292, cycles 0.7739), tier-up+OSR Score 253.269 (0.7989, 0.3055, 1.0851, 0.7608), and +Optimizing Score 252.852 (0.7996, 0.3054, 1.0897, 0.7620). Tier-up improves the interpreter, but the extra layer is not a measured net win over tier-up on ARM64; the closing monotonicity/status-table gate is therefore not satisfied. |
