...
Current measured evidence: the focused suite passes 66/66 and the upstream
...
66/66, upstream parallel 178/178).
...
by `test-os.js` (focused 66/66, upstream parallel 178/178). `homedir`/`tmpdir`
