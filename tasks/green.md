...
Current measured evidence: the focused suite passes 65/65 and the upstream
...
65/65, upstream parallel 178/178).
...
by `test-os.js` (focused 65/65, upstream parallel 178/178). `homedir`/`tmpdir`
