# Task 058: `ink-function-params` Example — Default Params, Rest Params
...
Parser's `func_expr_params` extracts params but ignores defaults and rest. Need to:
1. Parse default values into `Param.default`
2. Parse rest parameter (`...args`) into HIR
