...
mod integration_tests {
    ...
    fn test_full_transpile_simple_component() {
        ...
        let has_type = module.items.iter().any(|item| matches!(item, ModuleItem::Decl(Decl::Type(_))));
    ...
    fn test_full_transpile_island() {
        ...
        let has_import = module.items.iter().any(|item| matches!(item, ModuleItem::Import(_)));
