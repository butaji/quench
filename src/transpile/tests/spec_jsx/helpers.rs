...
pub fn find_jsx_expr_in_stmt(module: &Module) -> Option<JSXExpr> {
    for item in &module.items {
...
pub fn assert_jsx_parses(source: &str) -> JSXExpr {
...
pub fn assert_codegen_not_empty(jsx: &JSXExpr) {
