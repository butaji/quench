...
pub struct ValueFunction {
    ...
    pub body: Vec<super::ast::Statement>,
    /// Arrow function body (expression or block)
    pub arrow_body: Option<Box<super::ast::ArrowBody>>,
    /// Closure environment - variables visible in this scope
    pub closure: Rc<RefCell<super::env::Environment>>,
